...
export default function TransferConfirmDrawer({
  ...
  return (
    <div className="fixed inset-0 z-30 khan-drawer-overlay-enter">
      ...
      <div className="fixed inset-x-0 bottom-0 top-[85px] z-40 mx-auto w-full rounded-t-[20px] bg-[#ececec] px-4 pb-6 pt-4 khan-drawer-content-enter">
        <div className="h-full overflow-y-auto pb-[max(10px,env(safe-area-inset-bottom))] ">
          ...
          <div className="mt-4 flex gap-2 rounded-[10px] bg-[#fef1c7] px-4 py-3 text-[#dc7f18]">
            <WarningBadgeIcon />
            <p className="px-5 text-[16px] font-medium leading-[1.35] text-[#d36c0f]">
              Та гүйлгээ хийхээсээ өмнө банк,
              <span className="block">хүлээн авагчийн мэдээлэл, дансны дугаар, мөнгөн дүнг дахин хянаж</span>
              баталгаажуулна уу.
            </p>
          </div>

          <div className="mt-3 rounded-[12px] bg-[#ffffff] px-4 py-5 text-center">
            <div className="mx-auto flex w-[72px] justify-center rounded-[6px] bg-[#dfe3e9] py-1 text-[18px] font-medium items-center text-[#9ca3ad] h-[40px]">
              MNT
            </div>
          ...
          <div className="mt-3 rounded-[12px] bg-[#ffffff] px-4 py-4">
